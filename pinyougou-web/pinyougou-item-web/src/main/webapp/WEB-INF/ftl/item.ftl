		...
		<div id="item">
			<div class="crumb-wrap">
				...
				<ul class="sui-breadcrumb">
					<li><a href="#">${itemCat1Name}</a></li>
					<li><a href="#">${itemCat2Name}</a></li>
					<li><a href="#">${itemCat3Name}</a></li>
						...
						<div class="tab-content tab-wraped">
							...
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeItems as c>
										<#if c.value??>
										<#--[{"text":"分辨率","value":"1136×640"},{"text":"摄像头","value":"800万像素"}]-->
